...
// =========================================================================
const CONFIG = {
    N8N_LOGIN_WEBHOOK: "http://localhost:3000/webhook/library-auth",
    N8N_REGISTER_WEBHOOK: "http://localhost:3000/webhook/library-registration",
    N8N_SYNC_WEBHOOK: "http://localhost:3000/webhook/library-sync",
    N8N_TRANSACTION_WEBHOOK: "http://localhost:3000/webhook/library-update",
    N8N_CHANGE_PIN_WEBHOOK: "http://localhost:3000/webhook/library-change-pin",
    N8N_VERIFY_WEBHOOK: "http://localhost:3000/webhook/library-verify-account",
    N8N_RESERVE_WEBHOOK: "http://localhost:3000/webhook/library-reserve",
    N8N_CANCEL_RESERVATION_WEBHOOK: "http://localhost:3000/webhook/library-cancel-reservation",
    N8N_ADMIN_OVERVIEW_WEBHOOK: "http://localhost:3000/webhook/library-admin-overview",
